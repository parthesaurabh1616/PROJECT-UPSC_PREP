...
const MODULES = [
  { icon: Brain,        title: "AI Mentor",                desc: "A ChatGPT-grade tutor grounded in your notes, the syllabus and 22 years of PYQs." },
  ...
  { icon: FileBarChart, title: "Notes & Knowledge Graph",  desc: "Obsidian-style second brain — backlinks, nested pages, visual neural map." },
  ...
  { icon: PenLine,      title: "Mains Answer Lab",         desc: "Upload handwritten answers · AI structure scoring · intro-body-conclusion analysis." },
...
export default function LandingPage() {
  return (
    <div className="relative">
      <section className="relative isolate min-h-screen overflow-hidden">
        ...
        <nav className="relative z-20 mx-auto flex max-w-7xl items-center justify-between px-6 pt-7 md:px-10">
          <Link href="/" className="flex items-center gap-3">
            <span className="relative grid h-10 w-10 place-items-center rounded-xl border border-line bg-gradient-to-br from-accent/40 via-accent-2/30 to-analyt/30 font-display text-base font-bold text-ink">
              PO
          ...
          <div className="hidden items-center gap-1 rounded-full border border-line bg-surface/40 px-2 py-1.5 backdrop-blur-xl md:flex">
            {["Command", "Mentor", "Notes", "Affairs", "Revision"].map((n) => (
              <a key={n} href="#capabilities" className="rounded-full px-3.5 py-1.5 font-mono text-[10.5px] uppercase tracking-[0.22em] text-ink-2 transition-colors hover:bg-surface-2/60 hover:text-ink">
                {n}
              </a>
            ))}
          </div>
          ...
          <div className="max-w-4xl">
            <div className="mb-6 inline-flex items-center gap-2.5 rounded-full border border-line bg-surface/40 px-4 py-2 backdrop-blur">
              ...
              <span className="font-mono text-[10.5px] uppercase tracking-[0.26em] text-ink-2">
                AIR-1 Preparation System . v 0.1
              </span>
            </div>
            ...
            <h1 className="editorial text-[64px] font-semibold leading-[0.98] tracking-tight text-ink md:text-[88px] lg:text-[112px]">
              ...
              <br />
              <span className="font-display font-bold">PREP OS</span>
            </h1>

            <p className="mt-7 max-w-2xl font-display text-[18px] font-medium leading-snug text-ink md:text-[22px]">
              The AI-powered cognitive operating system for{" "}
              <span className="text-accent">elite</span>{" "}
              UPSC preparation.
            </p>
            <p className="mt-4 max-w-2xl text-[14.5px] leading-relaxed text-ink-2 md:text-[15.5px]">
              Build deep mastery through intelligent revision systems, AI mentorship,
              current-affairs intelligence, strategic analytics, and AIR-1 level
              preparation workflows - engineered for an aspirant who treats the journey
              as a craft.
            </p>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              ...
              >
                ...
                <span className="pointer-events-none absolute inset-0 -z-10 rounded-full opacity-0 blur-2xl transition-opacity group-hover:opacity-70"
            ...
            <div className="mt-16 grid max-w-3xl grid-cols-2 gap-x-8 gap-y-4 md:grid-cols-4">
              {STATS.map((s) => (
                <div key={s.l} className="border-l border-line pl-4">
                  ...
                  <p className="mt-1.5 font-mono text-[9.5px] uppercase tracking-[0.18em] text-ink-3">
                    {s.l}
                  </p>
                </div>
              ))}
      ...
      <section id="capabilities" className="relative mx-auto max-w-7xl px-6 py-32 md:px-10">
        <div className="mb-14 max-w-3xl">
          ...
          <h2 className="section-title">
            <span className="text-gradient-cool">Twelve modules</span>,
            <br />
            one cognitive war room.
          </h2>
          <p className="mt-5 text-[15px] leading-relaxed text-ink-2">
            Not another EdTech dashboard. A strategic preparation laboratory -
            built like Palantir engineered it for future IAS officers.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    background: "radial-gradient(420px circle at 50% 0%, rgb(var(--accent) / 0.14), transparent 55%)",
                  }}
                />
      ...
      <section className="relative mx-auto max-w-5xl px-6 py-32 md:px-10">
        <div className="relative overflow-hidden rounded-3xl border border-line bg-surface/40 p-12 backdrop-blur-xl md:p-16">
          ...
          <div className="relative">
            ...
            <p className="editorial text-[36px] font-medium italic leading-[1.18] tracking-tight text-ink md:text-[48px]">
              <span className="text-accent">योगः कर्मसु कौशलम्</span> -
              excellence in action is yoga. Preparation is not a checklist; it
              is a discipline you live inside.
            </p>
            <p className="mt-8 font-mono text-[10.5px] uppercase tracking-[0.26em] text-ink-3">
              Bhagavad Gita . 2.50 - the OS philosophy
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative mx-auto max-w-7xl px-6 py-32 md:px-10">
        <div className="text-center">
          ...
          <h2 className="section-title mb-6">
            <span className="text-gradient">Step into</span> the command center.
          </h2>
          <p className="mx-auto max-w-2xl text-[15px] leading-relaxed text-ink-2">
            Your dashboard knows the syllabus. It knows the PYQs. It will know
            your notes. The only thing left is your discipline.
          </p>
        ...
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-6 py-8 md:px-10">
          <div>
            ...
            <p className="mt-1 font-mono text-[9.5px] uppercase tracking-[0.22em] text-ink-3">
              v0.1 . Built for the aspirant who treats preparation as a craft
            </p>
          </div>
          <div className="flex items-center gap-2">
            <Tag intent="muted">Next.js 15</Tag>
            <Tag intent="muted">Supabase</Tag>
            <Tag intent="muted">RAG . pgvector</Tag>
          </div>
        </div>
      </footer>
    </div>
