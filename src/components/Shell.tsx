...
const NAV: { section: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { label: "Crux · Institute",href: "/crux",            icon: BookMarked },
      ...
      { label: "Exam-Eve Kits",   href: "/eve",             icon: FileStack, badge: "AI" },
...
const PAGE_META: Record<string, { eyebrow: string; title: string }> = {
  ...
  "/crux":            { eyebrow: "INSTITUTE MATERIAL", title: "Crux — Class Notes" },
  ...
  "/eve":             { eyebrow: "COS · EXAM-EVE ENGINE",  title: "Revision Kits" },
